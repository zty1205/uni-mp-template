      ...
      if (typeof m.exports === "object") {
        ...
        Object.keys(m.exports).forEach(function(k) {
          ...
          if (desp && desp.configurable)
            Object.defineProperty(m.exports, k, {
              set: function(val) {
        ...
        if (m.exports.__esModule)
          Object.defineProperty(__MODS__[modId].m.exports, "__esModule", {
            value: true
          });
      } else {
        ...
        return (function(t) {
          ...
          function(t, e, o) {
            ...
            var r = (function() {
              ...
              function k(t, e) {
                if (void 0 !== t.style.marginStart && L(e))
              ...
              function j(t, e) {
                if (void 0 !== t.style.marginEnd && L(e))
              ...
              function G(t, e) {
                void 0 === t.layout[S[e]] &&
                  N(t, e) &&
                  (t.layout[S[e]] = U(z(t, e, t.style[S[e]]), R(t, e)));
              }
              function J(t, e, o) {
                e.layout[x[o]] =
                  t.layout[S[o]] - e.layout[S[o]] - e.layout[w[o]];
              }
              function K(t, e) {
              ...
              function Q(r, E, Q) {
                var X = (function(t, r) {
                    var i;
                    return (
                      (i = t.style.direction ? t.style.direction : e) === e &&
                        (i = void 0 === r ? o : r),
                      i
                    );
                  })(r, Q),
                ...
                G(r, Y),
                  G(r, Z),
                  (r.layout.direction = X),
                  (r.layout[b[Y]] += k(r, Y) + K(r, Y)),
                  (r.layout[x[Y]] += j(r, Y) + K(r, Y)),
                  (r.layout[b[Z]] += k(r, Z) + K(r, Z)),
                  (r.layout[x[Z]] += j(r, Z) + K(r, Z));
                ...
                if (
                  ...
                  if (it || lt) {
                    ...
                    it && (r.layout.width = nt.width + et),
                      lt && (r.layout.height = nt.height + R(r, n));
                  }
                  if (0 === tt) return;
                }
                var at,
                ...
                for (
                  var Wt = 0, Lt = 0, kt = 0, jt = 0, Bt = 0, Et = 0;
                  Lt < tt;
                  ...
                  for (at = Wt; at < tt; ++at) {
                    if (
                      (((dt = r.children[at]).lineIndex = Et),
                      (dt.nextAbsoluteChild = null),
                      (dt.nextFlexChild = null),
                      (Xt = A(r, dt)) === g && H(dt) === v && mt && !N(dt, Z))
                    )
                      dt.layout[S[Z]] = U(
                        z(dt, Z, r.layout[S[Z]] - gt - _(dt, Z)),
                        R(dt, Z)
                      );
                    else if (H(dt) === m)
                      for (
                        null === xt && (xt = dt),
                          null !== wt && (wt.nextAbsoluteChild = dt),
                          wt = dt,
                          ut = 0;
                        ut < 2;
                        ut++
                    ...
                    if (
                      (vt && M(dt)
                        ...
                        : ((Ct = t),
                          ...
                          0 === kt && V(dt, Ct, X),
                          H(dt) === v && (Rt++, (qt = I(dt, Y)))),
                      yt && vt && Tt + qt > St && at !== Wt)
                    ) {
                      Rt--, (kt = 1);
                      break;
                    }
                    At && (H(dt) !== v || M(dt)) && ((At = !1), (Pt = at)),
                      Dt &&
                        (H(dt) !== v ||
                          (Xt !== g && Xt !== f) ||
                          W(dt.layout[S[Z]])) &&
                      ...
                      At &&
                        ...
                        vt && J(r, dt, Y),
                        (Nt += I(dt, Y)),
                        (Ft = U(Ft, z(dt, Z, I(dt, Z))))),
                      Dt && ((dt.layout[w[Z]] += jt + ht), mt && J(r, dt, Z)),
                      (kt = 0),
                      (Tt += qt),
                      (Lt = at + 1);
                  }
                  ...
                  if (((Gt = vt ? St - Tt : U(Tt, 0) - Tt), 0 !== Ot)) {
                    var Jt,
                      ...
                      Qt = Gt / _t;
                    for (It = Mt; null !== It; )
                      (Jt = Qt * It.style.flex + R(It, Y)) !==
                        (Kt = z(It, Y, Jt)) &&
                        ((Gt -= Kt), (_t -= It.style.flex)),
                        (It = It.nextFlexChild);
                    for ((Qt = Gt / _t) < 0 && (Qt = 0), It = Mt; null !== It; )
                      (It.layout[S[Y]] = z(
                        It,
                        Y,
                        Qt * It.style.flex + R(It, Y)
                      )),
                        (Ct = t),
                        N(r, $)
                          ? (Ct = r.layout[S[$]] - et)
                    ...
                    ct !== u &&
                      (ct === d
                        ...
                        : ct === y
                        ? ((Gt = U(Gt, 0)),
                          (Ut = Ot + Rt - 1 != 0 ? Gt / (Ot + Rt - 1) : 0))
                        : ct === c && (zt = (Ut = Gt / (Ot + Rt)) / 2));
                  for (Nt += zt, at = Pt; at < Lt; ++at)
                    H((dt = r.children[at])) === m && F(dt, b[Y])
                      ? (dt.layout[w[Y]] = q(dt, b[Y]) + B(r, Y) + k(dt, Y))
                      : ((dt.layout[w[Y]] += Nt),
                        vt && J(r, dt, Y),
                        H(dt) === v &&
                          ((Nt += Ut + I(dt, Y)),
                  ...
                  var Vt = r.layout[S[Z]];
                  for (
                    mt || (Vt = U(z(r, Z, Ft + gt), gt)), at = Ht;
                    at < Lt;
                    ++at
                  )
                    if (H((dt = r.children[at])) === m && F(dt, b[Z]))
                      dt.layout[w[Z]] = q(dt, b[Z]) + B(r, Z) + k(dt, Z);
                    else {
                      var Xt,
                        Yt = ht;
                      if (H(dt) === v)
                  ...
                  for (at = 0; at < Et; ++at) {
                    ...
                    for (ut = le; ut < tt; ++ut)
                      if (H((dt = r.children[ut])) === v) {
                        ...
                        W(dt.layout[S[Z]]) ||
                          (ne = U(ne, dt.layout[S[Z]] + _(dt, Z)));
                      }
                    for (ie = ut, ne += ee, ut = le; ut < ie; ++ut)
                      if (H((dt = r.children[ut])) === v) {
                        var ae = A(r, dt);
                        if (ae === f) dt.layout[w[Z]] = oe + k(dt, Z);
                        else if (ae === p)
                          dt.layout[w[Z]] =
                            oe + ne - j(dt, Z) - dt.layout[S[Z]];
                        else if (ae === h) {
                ...
                if (
                  (vt ||
                    ((r.layout[S[Y]] = U(z(r, Y, Bt + T(r, Y)), pt)),
                    (Y !== l && Y !== a) || (de = !0)),
                  mt ||
                    ((r.layout[S[Z]] = U(z(r, Z, jt + gt), gt)),
                    (Z !== l && Z !== a) || (se = !0)),
                  de || se)
                )
                  for (at = 0; at < tt; ++at)
                  ...
                  for (ut = 0; ut < 2; ut++)
                    (st = 0 !== ut ? i : n),
                      ...
                      F(wt, x[st]) &&
                        !F(wt, b[st]) &&
                        (wt.layout[b[st]] =
                          r.layout[S[st]] - wt.layout[S[st]] - q(wt, x[st]));
                  (dt = wt),
                    (wt = wt.nextAbsoluteChild),
                    (dt.nextAbsoluteChild = null);
                }
              }
              function V(t, e, r) {
